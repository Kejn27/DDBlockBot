...
public:
	...
	enum
	{
		...
		SETTING_HELPADMIN,
		SETTING_ADD_IGNORE,
		SETTING_CLEAR_IGNORE,
		SETTING_IDLE,
		SETTING_COUNT
	};
	std::string BotSettings[SETTING_COUNT];

	// Points for Copy Love Box
	enum
	{
		POINT_RIGHT_UP,
		POINT_LEFT_UP,
...
private:
	...
	void left()
	{
		m_Controls.m_InputDirectionLeft[0] = 1;
		m_Controls.m_InputDirectionRight[0] = 0;
	}
	void right() 
	{
		m_Controls.m_InputDirectionLeft[0] = 0;
		m_Controls.m_InputDirectionRight[0] = 1;
	}
	void move_none() {
		m_Controls.m_InputDirectionLeft[0] = 0;
		m_Controls.m_InputDirectionRight[0] = 0;
	...
	void hook()
	{
		m_Controls.m_InputData[0].m_Hook = !m_Controls.m_InputData[0].m_Hook;
	}
	void jump()
	{
	...
	void OnMenu(const char *aCmd, const char *aArg);
	...
	void SetSetting(int var, const char *val);
	char *GetSetting(int var);
